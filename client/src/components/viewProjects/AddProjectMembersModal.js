...
export default function AddProjectMembersModal() {
    ...
    const [addMembersInput, setAddMembersInput] = useState({ newMembers: [] });
    ...
    const handleAddMember = (member) => {
        ...
        setAddMembersInput((prevState) => (Object.assign(Object.assign({}, prevState), { newMembers: [...prevState.newMembers, member] })));
    };
    const handleRemoveMember = (member) => {
        const newProjectMembers = addMembersInput.newMembers.filter((user) => user !== member);
        setAddMembersInput((prevState) => (Object.assign(Object.assign({}, prevState), { newMembers: [...newProjectMembers] })));
    };
    ...
    return (React.createElement("div", null,
        React.createElement(Button, { onClick: handleOpen, sx: { margin: 3, color: "white", backgroundColor: "#676767", border: "1px solid black", borderRadius: "10px", '&:hover': { backgroundColor: "#a9f6ae", color: "black" } } }, "Add Members to Project!"),
            ...
            React.createElement(Box, { sx: style },
                React.createElement(Grid, { sx: { display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" } },
                    React.createElement(Grid, { sx: { textAlign: "center", width: "100%", borderBottom: "1px solid black" } },
                        React.createElement(Typography, { id: "modal-modal-title", variant: "h4", sx: { color: "white" } }, "Add New Members!")),
                    React.createElement(SearchUsersCard, { handleAddMember: handleAddMember }),
                    membersExist(addMembersInput.newMembers) && React.createElement(Typography, { variant: "h6", sx: { color: "white", borderBottom: "1px solid black" } }, "Members"),
                    React.createElement(Grid, { sx: { display: "flex", flexDirection: "row", justifyContent: "center", flexWrap: "wrap" } }, addMembersInput.newMembers && addMembersInput.newMembers.map((member) => {
                    ...
                    React.createElement(Grid, { sx: { display: "flex", justifyContent: "center", width: "100%", borderTop: "1px solid black" } },
                        React.createElement(Button, { sx: { color: "black", backgroundColor: "#a9f6ae", border: "1px solid black", borderRadius: "10px", marginTop: "5%", '&:hover': { backgroundColor: "#86c48a" } }, onClick: handleAddMembersToProject }, "Create Project")))))));
}
