...
exports.flashcardResolvers = {
    ...
    Mutation: {
        async createFlashcard(_, { input }, context) {
            ...
            const result = await dbConnection_1.pool.query('INSERT INTO flashcards (user_id, card_type, content, answer) VALUES ($1, $2, $3, $4) RETURNING *', [userId, card_type, content, answer]);
